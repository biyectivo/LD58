...
instance_create_layer(_x, _y, "lyr_Player", obj_Shooter);
Game.target_score = Game.game_data.total_score + 1000;
instance_create_layer(self.x, self.y, "lyr_Score", obj_Score_Shown, {score_value: 1000});
self.light.Destroy();
