...
instance_create_layer(_x, _y, "lyr_Player", obj_Dasher);
Game.target_score = Game.game_data.total_score + 300;
instance_create_layer(self.x, self.y, "lyr_Score", obj_Score_Shown, {score_value: 300});
self.light.Destroy();
