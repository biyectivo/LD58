...
instance_create_layer(_x, _y, "lyr_Player", obj_Chaser);
Game.target_score = Game.game_data.total_score + 100;
instance_create_layer(self.x, self.y, "lyr_Score", obj_Score_Shown, {score_value: 100});
self.light.Destroy();
